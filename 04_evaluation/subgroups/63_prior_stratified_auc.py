...
Output: results_vte/ajm/new/output_era/prior_vte_stratified_auc.json
"""
import json
import numpy as np
import pandas as pd
...
with open(f'{RES}/ajm/new/output_era/prior_vte_stratified_auc.json', 'w') as f:
    json.dump(out, f, indent=2)
print('Saved -> results_vte/ajm/new/output_era/prior_vte_stratified_auc.json')
