...
def main():
    lab = pd.read_parquet(f'{RES}/ajm/new/data/vte_labels_inclprior_excl24h.parquet')
    keep = set(json.load(open(f'{RES}/ajm/new/data/inclprior_excl24h_kept_ids.json')))
    ...
    pd.DataFrame({'hadm_id': strict.hadm_id}).to_parquet(
        f'{RES}/ajm/new/output/strict_control_ids_inclprior_excl24h.parquet')
    ...
    path = f'{RES}/ajm/new/output/strict_control_apples2apples_inclprior_excl24h.json'
