...
Outputs:
  ...
  results_vte/ajm/new/output_era/Figure_2_calibration_inclprior_excl24h.png, results_vte/ajm/new/output_era/Figure_3_dca_inclprior_excl24h.png
"""
import json
import warnings
...
fig.tight_layout()
fig.savefig('results_vte/ajm/new/output_era/Figure_2_calibration_inclprior_excl24h.png', dpi=300)
print('saved results_vte/ajm/new/output_era/Figure_2_calibration_inclprior_excl24h.png', flush=True)
...
fig.tight_layout()
fig.savefig('results_vte/ajm/new/output_era/Figure_3_dca_inclprior_excl24h.png', dpi=300)
print('saved results_vte/ajm/new/output_era/Figure_3_dca_inclprior_excl24h.png', flush=True)
...
with open(f'{RES}/ajm/new/output_era/revision_threshold_calib_inclprior_excl24h.json', 'w') as f:
