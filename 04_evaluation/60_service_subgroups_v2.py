...
def main():
    ...
    with open(f'{RES}/ajm/new/output/service_subgroups_inclprior_excl24h.json', 'w') as f:
        json.dump(out, f, indent=2)
    print('saved ->', f' {RES}/ajm/new/output/service_subgroups_inclprior_excl24h.json')
