...
Output: results_vte/ajm/new/output_era/review_gap_results_inclprior_excl24h.json
"""
...
with open(f'{RES}/ajm/new/output_era/review_gap_results_inclprior_excl24h.json', 'w') as f:
    json.dump(out, f, indent=2)
print('Saved -> results_vte/ajm/new/output_era/review_gap_results_inclprior_excl24h.json',
      flush=True)
